...
const EMPTY_ANSWER: Answer = { num: 0, den: 1 };

type Feedback = { correct: boolean; message: string } | null;

export default function RadicalEvalPracticePanel({ level, onResult }: Props) {
  ...
  return (
    <div className="rounded-2xl border border-brand-line bg-brand-panel p-5">
      ...
      <p className="mt-3 text-center font-mono text-2xl text-brand-ink">Evaluate: {problem.display}</p>
